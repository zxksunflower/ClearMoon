...
SSL_CERT_PATH = os.path.join(SSL_FILE_DIR, 'server.crt')
SSL_KEY_PATH = os.path.join(SSL_FILE_DIR, 'server.key')
SSL_CA_PATH = os.path.join(SSL_FILE_DIR, 'ca.crt')


class Settings(BaseSettings):
    ssl_mode: str = "one_way"  # 或 "two_way"
...
if __name__ == "__main__":
    ...
    uvicorn.run(
        ...
        ssl_ca_certs=SSL_CA_PATH if settings.ssl_mode == "two_way" else None,
